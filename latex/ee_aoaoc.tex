...
\begin{document}
	...
	\qquad 1. Using AOAOC in unmodified Four Rooms
	
	\qquad 2. Using AOAOC in modified Four Rooms
	
	\qquad 3. Using Deliberation Cost in unmodified Four Rooms
	
	\qquad 4. Using Deliberation Cost in modified Four Rooms
	...
	\begin{figure}[H]
		\centering
		\begin{tabular}{ccccc}
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.01/dc_1/run_0.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.01/dc_1/run_1.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.01/dc_1/run_2.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.01/dc_1/run_3.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.01/dc_1/run_4.png}} \\		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.05/dc_1/run_0.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.05/dc_1/run_1.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.05/dc_1/run_2.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.05/dc_1/run_3.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.05/dc_1/run_4.png}} \\
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.1/dc_1/run_0.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.1/dc_1/run_1.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.1/dc_1/run_2.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.1/dc_1/run_3.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.1/dc_1/run_4.png}} \\
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.2/dc_1/run_0.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.2/dc_1/run_1.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.2/dc_1/run_2.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.2/dc_1/run_3.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.2/dc_1/run_4.png}} \\
		\end{tabular}
	...
	\centering
	\begin{tabular}{ccccc}
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.01/dc_2/run_0.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.01/dc_2/run_1.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.01/dc_2/run_2.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.01/dc_2/run_3.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.01/dc_2/run_4.png}} \\
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.05/dc_2/run_0.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.05/dc_2/run_1.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.05/dc_2/run_2.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.05/dc_2/run_3.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.05/dc_2/run_4.png}} \\
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.1/dc_2/run_0.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.1/dc_2/run_1.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.1/dc_2/run_2.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.1/dc_2/run_3.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.1/dc_2/run_4.png}} \\
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.2/dc_2/run_0.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.2/dc_2/run_1.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.2/dc_2/run_2.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.2/dc_2/run_3.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/aoaoc_hard/wo_0.2/dc_2/run_4.png}} \\
	\end{tabular}
	...
	\begin{figure}[H]
		\centering
		\begin{tabular}{ccccc}
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_0.5/run_0.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_0.5/run_1.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_0.5/run_2.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_0.5/run_3.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_0.5/run_4.png}} \\
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_1/run_0.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_1/run_1.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_1/run_2.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_1/run_3.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_1/run_4.png}} \\
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_2/run_0.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_2/run_1.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_2/run_2.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_2/run_3.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_2/run_4.png}} \\
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_3/run_0.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_3/run_1.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_3/run_2.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_3/run_3.png}} &
			\subfloat{\includegraphics[width=0.8in]{result/dc_hard/dc_3/run_4.png}} \\
		\end{tabular}
	...
	\centering
	\begin{tabular}{ccccc}
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_0.5/run_0.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_0.5/run_1.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_0.5/run_2.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_0.5/run_3.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_0.5/run_4.png}} \\
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_1/run_0.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_1/run_1.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_1/run_2.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_1/run_3.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_1/run_4.png}} \\
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_2/run_0.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_2/run_1.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_2/run_2.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_2/run_3.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_2/run_4.png}} \\
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_3/run_0.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_3/run_1.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_3/run_2.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_3/run_3.png}} &
		\subfloat{\includegraphics[width=0.8in]{result/dc_easy/dc_3/run_4.png}} \\
	\end{tabular}
	\caption{Deliberation Cost = 0.5, 1, 2 and 3 from top to bottom. Same row means same hyperparameters, each column is a different trial. }
	\end{figure}
	\section{Code}
